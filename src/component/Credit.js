...
export default class Credit extends Component {
  ...
  dateChange = b => {
    ...
    else if (b.target.value >= 3)
      return (b.target.value =
        b.target.value.replace(/[^0-9]/g, "").slice(0, 2) +
        "/" +
        b.target.value.replace(/[^0-9]/g, "").slice(2, 4));
    // b.target.value =
  ...
  render() {
    return (
      <div className="master_card">
        <div className="col-24 col-sm-6 company">
          <h1 className="title">Company Name</h1>
          <span>
            <img className="puce" src={Logo} alt="puce" />
          </span>
